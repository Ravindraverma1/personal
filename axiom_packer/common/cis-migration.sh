...
sed -i "/ClientAliveInterval/s/.*ClientAliveInterval.*/ClientAliveInterval\ 100/1" /etc/ssh/sshd_config 
sed -i "/ClientAliveCountMax/s/.*ClientAliveCountMax.*/ClientAliveCountMax\ 72/1" /etc/ssh/sshd_config 
